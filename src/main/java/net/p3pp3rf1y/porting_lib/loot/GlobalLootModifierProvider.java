...
public abstract class GlobalLootModifierProvider implements DataProvider {
	 ...
	 */
	public <T extends IGlobalLootModifier> void add(String modifier, T instance, List<ResourceCondition> conditions) {
	 ...
	 * @param conditions a list of conditions to add to the GLM file
	 */
	public <T extends IGlobalLootModifier> void add(String modifier, T instance, ResourceCondition... conditions) {
